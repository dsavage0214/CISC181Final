...
public class TestPMT {
	...
	public void TestPMT() {
		...
		// For a given r (rate), n (number of payments), p (present value), f (future
		// value), t (how compounding is applied)
	...
	public void TestLoanWithExtraPayment() {
		//TODO: Build me a unit test and test extra payments.
